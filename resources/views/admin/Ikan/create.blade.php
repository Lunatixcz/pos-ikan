...
@section('content')
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-4xl">Tambah Ikan</h1>s
    </div>
    <div class="card shadow-sm mt-4">
        <form class="form" method="POST" action="{{ route('ikan.store') }}">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label text-right">Nama Ikan</label>
                    <div class="col-lg-6">
                        <input type="text" name="nama_ikan" class="form-control form-control-solid" placeholder="Masukkan nama ikan..."/ required>
                    </div>
                </div>
